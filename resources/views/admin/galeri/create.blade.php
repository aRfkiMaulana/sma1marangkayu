        ...
        <form method="POST" action="{{ route('admin.galeri.store') }}" enctype="multipart/form-data">
            ...
            <div class="grid gap-5">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-1">Format jpg/png/webp. Maks 4MB.</p>
                ...
                <div class="grid sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="album" class="form-input"
                               value="{{ old('album') }}" placeholder="Nama album (opsional)">
                    </div>
                    <div>
                ...
                <div>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="is_highlight" value="1"
                               {{ old('is_highlight') ? 'checked' : '' }} class="w-4 h-4 rounded">
